        ...
        <div class="row">
          <div class="col-lg-4 col-sm-6">
            <div class="small-box bg-info">
              <div style="background-color:#ffd7ba" class="inner">
                <h3 id="transaksi_hari">0</h3>
                <p>Transaksi Hari Ini</p>
              </div>
              <div class="icon">
                <i style="background-color:#ffd7ba" class="fas fa-shopping-cart"></i>
              </div>
              <a href="<?php echo site_url('laporan_penjualan') ?>" style="background-color:#fec89a" class="small-box-footer">
          ...
          <div class="col-lg-4 col-sm-6">
            <div class="small-box bg-warning">
              <div style="background-color:#8ecae6" class="inner">
                <h3 id="transaksi_terakhir">0</h3>
                <p>Produk Transaksi Terakhir</p>
              </div>
              <div class="icon">
                <i style="background-color:#8ecae6" class="fas fa-money-bill"></i>
              </div>
              <a href="<?php echo site_url('laporan_penjualan') ?>" style="background-color:#58b4d1" class="small-box-footer">
                More Info <i class="fas fa-arrow-circle-right"></i>
              </a>
            </div>
          </div>
          <div class="col-lg-4 col-sm-6">
            <div class="small-box bg-danger">
              <div style="background-color:#fcd5ce" class="inner">
                <h3 id="stok_hari">0</h3>
                <p>Stok Masuk Hari Ini</p>
              </div>
              <div class="icon">
                <i style="background-color:#fcd5ce" class="fas fa-archive"></i>
              </div>
              <a href="<?php echo site_url('laporan_stok_masuk') ?>" style="background-color:#fec5bb" class="small-box-footer">
                More Info <i class="fas fa-arrow-circle-right"></i>
              </a>
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="card card-primary">
              <div style="background-color:#fec89a" class="card-header">
          ...
          <div class="col-md-6">
            <div class="card card-warning">
              <div style="background-color:#58b4d1" class="card-header">
          ...
          <div class="col-12">
            <div class="card card-success">
              <div style="background-color:#fec5bb" class="card-header">
